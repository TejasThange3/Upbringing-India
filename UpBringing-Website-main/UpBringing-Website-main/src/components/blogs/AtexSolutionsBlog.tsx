...
import atexImage from "./assets/atexsolution1.png";
import atexImage2 from "./assets/atexsolution2.png";
import atexImage3 from "./assets/atexsolution3.png";

export function AtexSolutionsBlog() {
        ...
        <article className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-red-600 to-red-700 h-80 flex items-center justify-center">
            <div className="text-center text-white px-8">
              ...
              <h1 className="text-4xl font-bold mb-4">Explosion-Proof Industrial Solutions and Advanced Vacuum Pump Technology for Safer, Smarter Operations</h1>
              {/* <p className="text-white/90 max-w-2xl mx-auto text-lg">
                Safer, Smarter Operations: Advanced explosion-proof systems and high-performance vacuum pump solutions for hazardous environments.
              </p> */}
            </div>
          </div>
